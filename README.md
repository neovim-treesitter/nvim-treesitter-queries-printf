# nvim-treesitter-queries-printf

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-printf/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-printf/actions/workflows/validate.yml)

Neovim tree-sitter queries for **printf**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-printf",
...
- [ ] Changes are scoped to `printf` — do not include files for other languages
